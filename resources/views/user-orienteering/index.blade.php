...
@section('navbar')
    ...
    <section id="userOrienteering">
        <div class="container mx-auto mt-32 lg:px-32 sm:px-6">
                ...
                <div class="search-bar">
                    <div class="relative lg:w-1/2 w-full mx-auto">
                        ...
                        <input type="search" id="searchInput"
                            class="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-orange-primary"
            ...
            <!-- Card Kegiatan -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 content">
                <div class="md:max-w-[480px] sm:max-w-full bg-white rounded-lg">
                    ...
                    <div class="flex flex-row gap-2">
                        <span class=""><i class="fa-solid fa-calendar-days opacity-75"></i></span>
                        <span class="text-sm">Sabtu, 11 Oktober 2024</span>
                    </div>
                </div>
                <div class="md:max-w-[480px] sm:max-w-full bg-white rounded-lg">
                    <a href="#">
