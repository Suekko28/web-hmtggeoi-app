...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Create', 'subtitle' => 'Orienteering Nasional'])
        ...
        <div class="card-body">
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('orienteering-nasional.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
