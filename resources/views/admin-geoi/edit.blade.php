...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Create', 'subtitle' => 'GEOI Fair'])
        ...
        <div class="card-body">
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('geoi-fair.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body container bg-white mt-5">
                            <div class="mempelai text-center fw-bold fs-5 mb-4">GEOI Fair</div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <img class="img-fluid" src="{{ Storage::url('geoi/' . $data->image) }}"
                            ...
                            <div class="d-flex flex-row-reverse mt-5">
                                ...
                                <a href="{{ route('geoi-fair.index') }}" class="btn btn-secondary">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
