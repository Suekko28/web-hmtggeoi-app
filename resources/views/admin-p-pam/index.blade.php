...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'P-PAM', 'subtitle' => 'Dashboard'])
    <div class="card w-100 position-relative overflow-hidden">
        {{-- <div class="px-4 py-3 border-bottom">
            <h4 class="card-title mb-0">Basic Table</h4>
        </div> --}}
        <div class="card-body">
            <a class="btn btn-primary mb-3" href="{{ route('p-pam.create') }}">+ Buat Artikel</a>
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <img class="img-fluid" src="{{ Storage::url('p-pam/' . $item->image) }}" width="120"
                                        height="120" alt="Foto P-PAM">
                                </td>
                                ...
                                <td>
                                    <div class="btn-group-horizontal">
                                        <a href="{{ route('p-pam.edit', $item->id) }}"
