...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Create', 'subtitle' => 'P-PAM'])
        ...
        <div class="card-body">
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('p-pam.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body container bg-white mt-5">
                            <div class="mempelai text-center fw-bold fs-5 mb-4">P-PAM</div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <img class="img-fluid" src="{{ Storage::url('p-pam/' . $data->image) }}"
                            ...
                            <div class="d-flex flex-row-reverse mt-5">
                                ...
                                <a href="{{ route('p-pam.index') }}" class="btn btn-secondary">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    ClassicEditor
        .create(document.querySelector('#description'), {
            ...
            simpleUpload: {
                ...
                uploadUrl: '{{ route('ckeditor.upload.ppam') }}',
