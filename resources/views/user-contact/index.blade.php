...
@section('navbar')
    ...
    <section id="userContactUs">
        ...
        <div class="container mx-auto mt-32 lg:px-32 sm:px-6">
            <div class="flex md:flex-nowrap sm:flex-wrap-reverse justify-center items-center gap-16 p-6 rounded-xl md:h-150 sm:h-190 content-contact">
                <div class="title w-full">
                    <h1 class="text-3xl font-extrabold text-orange-primary">Contact Us</h1>
        ...
        {{-- <div class="container mx-auto lg:px-32 sm:px-6">
            <div class="flex flex-wrap gap-6 justify-center items-center content">
                <div class="instagram">
                    <div
                        class="card p-6 bg-white border border-gray-200 shadow-lg w-120 rounded-xl transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl">
                        <div class="title">
                            <div class="flex flex-row items-center gap-2">
                                <img src="{{ asset('/images/logo-instagram-color.png') }}" alt=""
                                    class="object cover w-6 h-6">
