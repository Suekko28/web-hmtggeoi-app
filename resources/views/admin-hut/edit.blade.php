...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Create', 'subtitle' => 'Hut HMTG "GEOI"'])
        ...
        <div class="card-body">
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('hut-hmtg.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body container bg-white mt-5">
                            <div class="mempelai text-center fw-bold fs-5 mb-4">HUT HMTG "GEOI"</div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <img class="img-fluid" src="{{ Storage::url('hut/' . $data->image) }}"
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title"
                                            placeholder="Masukkan judul" value="{{ old('title', $data->title) }}">
                                    </div>
                            ...
                            <div class="d-flex flex-row-reverse mt-5">
                                ...
                                <a href="{{ route('hut-hmtg.index') }}" class="btn btn-secondary">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
