    ...
    <section id="userLanding">
            ...
            <div class="container mx-auto mt-32 lg:px-32 sm:px-6">
                <div class="title">
                    <div class="flex flex-row gap-2 items-center">
                        <div class="h-6 border-l-6 border-orange-200 rounded"></div>
        ...
        <section id="VisiMisi">
            <div class="container mx-auto mt-32 px-32 sm:px-6 lg:px-32 ">
                <div class="title">
                    <h1 class="font-extrabold text-center text-3xl text-orange-primary antialiased ">HMTGGEOI</h1>
                </div>
                <!-- VISI -->
        ...
        <section id="programKerja">
            <div class="container mx-auto mt-32 md:px-16 xl:px-32 sm:px-6">
                <div class="title">
                    <h1 class="text-orange-primary font-extrabold text-3xl text-center antialiased ">Program Kerja</h1>
                </div>
                ...
                <div class="flex lg:flex-nowrap sm:flex-wrap justify-center items-center gap-6 mt-12 content">
                    <div
                        ...
                        <img src="<?php echo e(asset('/images/icon-mine.png')); ?>" alt="" class="mb-2">
                        ...
                        <p class="text-gray-700 mb-4">
                            ...
                            aliquid
                            doloribus omnis soluta, at praesentium molestias natus dolore perspiciatis deserunt nisi totam
                            maiores
                    ...
                    <div
                        class="p-6 bg-white border border-gray-200 shadow-lg w-full rounded-xl transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl">
                        <img src="<?php echo e(asset('/images/icon-compass.png')); ?>" alt="" class="mb-2">
                        <h1 class=" font-bold text-2xl mb-2">Orienteering Nasional</h1>
                        <p class="text-gray-700 mb-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nam
                            quisquam
                            atque
                            consequuntur, optio
                            similique sed quam modi minima mollitia, libero quaerat ad? Libero dolore magni amet, totam
                            tenetur
                            beatae deleniti!</p>
                        <a href="#"
                            class="inline-flex items-center py-2 transition duration-300 ease-in-out transform hover:underline hover:text-orange-primary ">
                ...
                <div class="flex lg:flex-nowrap sm:flex-wrap justify-center items-center gap-6 mt-6 content">
                    <div
                        class="p-6 bg-white border border-gray-200 shadow-lg w-full rounded-xl transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl">
                        <img src="<?php echo e(asset('/images/icon-calender.png')); ?>" alt="" class="mb-2">
                        ...
                        <p class="text-gray-700 mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius odio
                            ...
                            earum quam id, placeat magni ratione repellat cupiditate. Amet sed vero aliquid quidem
                            reiciendis
                            eius
                    ...
                    <div
                        class="p-6 bg-white border border-gray-200 shadow-lg w-full rounded-xl transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl">
                        <img src="<?php echo e(asset('/images/icon-celebration.png')); ?>" alt="" class="mb-2">
                    ...
                    <div class="flex md:flex-nowrap sm:flex-wrap gap-6 content">
                        <div class="flex flex-col sm:w-full xl:w-full 2xl:w-1/2 gap-3 justify-center items-center">
                            <div class="logo-shopee">
                                <img src="<?php echo e(asset('/images/logo-shopee.png')); ?>" alt=""
                        ...
                        <div class="overflow-x-auto scroll-container scroll-smooth snap-x snap-mandatory">
                            <div class="flex gap-4 w-max px-4">
                                ...
                                <div
                                    ...
                                    <a href="#">
                                        <img class="rounded-t-lg" src="<?php echo e(asset('/images/visual-1.png')); ?>"
                                            alt="" />
                                    </a>
                                    <div class="p-5">
                                        <a href="#">
