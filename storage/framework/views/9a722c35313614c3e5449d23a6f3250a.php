        ...
        <div class="md:flex md:flex-nowrap sm:flex-wrap gap-24">
            <div class="mb-6 md:mb-0 md:w-1/2 sm:w-full">
                <div class="flex flex-col items-center md:flex-wrap lg:flex-nowrap justify-center gap-3">
                    <img src="<?php echo e(asset('/images/logo-hmtggeoi.png')); ?>" class="h-32 w-32 object-cover"
                        alt="HMTGGEOI Logo" />
...
<?php /**PATH C:\Users\USER\OneDrive\Documents\GitHub\web-hmtggeoi-app\resources\views/layouts/footer.blade.php ENDPATH**/ ?>