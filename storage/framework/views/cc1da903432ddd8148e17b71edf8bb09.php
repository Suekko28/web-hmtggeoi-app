    ...
    <nav id="mainNavbar" class="absolute top-0 left-0 w-full z-50 bg-transparent fixed">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="<?php echo e(asset('/images/logo-hmtggeoi.png')); ?>" class="h-12" alt="HMTGGEOI Logo" />
            ...
            <div class="flex lg:order-2 items-center space-x-2 rounded-lg">
                ...
                <div id="socialIcons" class="hidden sm:flex flex-row gap-6 py-2 px-6 items-center rounded-md">
                    <a href="">
                        <img class="w-5 h-5 object-contain transition duration-300 ease-in-out transform hover:opacity-75" src="<?php echo e(asset('/images/logo-instagram.png')); ?>" alt="Instagram">
                    </a>
                    <a href="">
                        <img class="w-6 h-6 object-contain transition duration-300 ease-in-out transform hover:opacity-75" src="<?php echo e(asset('/images/logo-youtube.png')); ?>" alt="YouTube">
                    </a>
                    <a href="">
                        <img class="w-5 h-5 object-contain transition duration-300 ease-in-out transform hover:opacity-75" src="<?php echo e(asset('/images/logo-email.png')); ?>" alt="Email">
                    </a>
                ...
                <button data-collapse-toggle="navbar-search" type="button"
                    class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
...
<?php echo $__env->make('layouts.app-user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\OneDrive\Documents\GitHub\web-hmtggeoi-app\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>